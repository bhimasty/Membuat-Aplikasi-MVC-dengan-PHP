      ...
      <ul class="list-group">
        <?php foreach ($data['mhs'] as $mhs) : ?>
          <li class="list-group-item">
            <?= $mhs['nama']; ?>
            <a href="<?= BASEURL; ?>/mahasiswa/hapus/<?= $mhs['id']; ?>" class="badge badge-danger float-right ml-1" onclick="return confirm('Hapus Data?')">Hapus</a>
        ...
        <form action="<?= BASEURL; ?>/mahasiswa/tambah" method="post">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="jurusan" name="jurusan">
              ...
              <option value="Teknik Elekto">Teknik Elekto</option>
            </select>
          </div>
      </div>
